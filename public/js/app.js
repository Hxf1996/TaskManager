    ...
    methods: {
        fetchSteps: function fetchSteps() {
            ...
            resource.query().then(function (response) {
                //success
                _this.$set('steps', response.body);
            }, function (response) {
                //error
                response.status;
            });
        },
        addStep: function addStep(newStep) {
            var _this2 = this;

            resource.save('', { name: newStep }).then(function (response) {
                _this2.fetchSteps();
            }, function (response) {
                response.status;
            });
...
},{"./components/stepList.vue":7,"vue":4,"vue-resource":3}],7:[function(require,module,exports){
...
exports.default = {
	...
	filters: {
		inProcess: function inProcess(steps) {
			return steps.filter(function (step) {
				return !step.completed;
			});
		},
		completed: function completed(steps) {
			return steps.filter(function (step) {
				return step.completed;
			});
		},
		typeSwitch: function typeSwitch(steps) {
			var vm = this;
			if (vm.type == "remaings") {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-826d682e", module.exports)
  } else {
    hotAPI.update("_v-826d682e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
