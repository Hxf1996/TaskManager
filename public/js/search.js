...
exports.default = {
	...
	methods: {
		fetchTasks: function fetchTasks() {
			...
			this.$http.get('/tasks/searchapi').then(function (response) {
				_this.$set('tasks', response.body);
				_this.show = true;
			}, function (response) {});
		},
	...
	filters: {
		searchFor: function searchFor(tasks, searchString) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-985bda72", module.exports)
  } else {
    hotAPI.update("_v-985bda72", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/search.vue":6,"vue":4,"vue-resource":3}]},{},[7]);
